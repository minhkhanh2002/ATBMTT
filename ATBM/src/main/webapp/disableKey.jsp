	...
	<div class="container-fluid">
		<div class="body">
			<div class="container">
				...
				<h2 style="text-align: center; margin-top: 30px;">Xác nhận lộ
					private key</h2>
				<div class="alert alert-success text-center"
					<c:if test="${ sucess ==null}">style="display: none"</c:if>>${sucess}</div>

				<form action="<%=request.getContextPath()%>/disableKey"
					method="post">
					...
					<div class="form-outline">
						<label class="form-label" for="form3Example1cg">Chữ kí(*):</label>
						<input type="text" id="form3Example1cg" class="form-control "
							required name="signature" value="<%=signature%>" />
					</div>
					<p style="color: red;">${message.get("signatureError")}</p>
					<div>
