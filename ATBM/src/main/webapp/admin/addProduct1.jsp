			...
			<div class="container-fluid">
				...
				<div class="col-md-12">
					...
					<div class="card">
						...
						<div class="card-body">
							<form class="form-horizontal form-material" action="add_product"
								...
								<div class="form-group mb-4">
									...
									<div class="col-md-12 border-bottom p-0">
										<img style="width: 80px; height: 80px;" id="picture"
								...
								<div class="form-group mb-4">
									...
									<div class="justify_bettwen ml-3">
										<div class="item-para">
											...
											<div class="col-md-12">
												<input type="number" class="" name="height"
										...
										<div class="item-para">
											...
											<div class="col-md-12">
												<input type="number" class="" name="length"
													required="required"> cm
											</div>
										</div>
										...
										<div class="item-para">
											...
											<div class="col-md-12">
												<input type="number" class="" name="weigth"
								...
								<div class="form-group mb-4">
									<div class="col-sm-12">
										<button class="btn btn-success" name="add" type="submit">Thêm
											sản phẩm</button>
