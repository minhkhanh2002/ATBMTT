								...
								<form class="form-horizontal form-material">
									<div class="form-group mb-4">
										<div class="col-sm-12" align="right">
											<a class="btn btn-primary" href="${contextPath}/manager_log">Trở
												về</a>
										</div>
									</div>
									<h3 class="box-title text-uppercase text-center mb-3">Chi
										tiết Log #${log.id }</h3>
									...
									<div class="form-group mb-4">
										...
										<div class="col-md-12 border-bottom p-0">
											<input type="text" placeholder="Johnathan Doe"
												class="form-control p-0 border-0" value="${log.id }"
									...
									<div class="form-group mb-4">
										<label for="example-email" class="col-md-12 p-0"><b>Tài
												khoản</b></label>
										<div class="col-md-12 border-bottom p-0">
											<input class="form-control p-0 border-0" name="eUserName"
									...
									<div class="form-group mb-4">
										...
										<div class="col-md-12 border-bottom p-0">
											<input type="email" value="${log.src}"
									...
									<div class="form-group mb-4">
										...
										<div class="col-md-12 border-bottom p-0">
											<input class="form-control p-0 border-0" readonly
												value="${log.converDate()}">
										</div>
									</div>
